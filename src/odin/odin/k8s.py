...
class Task:
    ...
    def from_dict(cls, dict_value: Dict) -> 'Job':
        ...
        cpu_req = Cpu(cpu_req['limits'], cpu_req['requests']) if cpu_req is not None else None
        security_context = dict_value.get('security_context', None)
        security_context = SecurityContext(security_context['fs_group'], security_context['run_as_group'], security_context['run_as_user'])
